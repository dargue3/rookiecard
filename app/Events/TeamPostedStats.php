...
class TeamPostedStats extends Event implements CreatesNewsFeedEntries, NotifiesUsers
{
    ...
    /**
     * Meta data for the stats that were created
     * 
     * @var array
     */
    public $meta;
     ...
     * @return void
     */
    public function __construct($team_id, $meta)
    {
