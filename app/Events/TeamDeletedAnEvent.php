...
class TeamDeletedAnEvent extends Event implements CreatesNewsFeedEntries, NotifiesUsers
{
     ...
     * @return void
     */
    public function __construct($team_id, $event)
    {
